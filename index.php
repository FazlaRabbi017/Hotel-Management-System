        ...
        <div class="swiper swiper-testimonials">
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4">
                    ...
                    <p>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Adipisci numquam dolorum itaque ipsam inventore asperiores excepturi mollitia in minima esse!
                    </p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
